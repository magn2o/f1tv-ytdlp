...
const getContentStreamUrl = (id, channel = null) => {
    ...
    const options = {
        ...
        headers: {
            ...
            'x-f1-device-info': 'device=web;screen=browser;os=mac os;browser=safari;browserVersion=18.3.1;model=Macintosh;osVersion=10.15.7;appVersion=release-R39.4.0-alpha25;playerVersion=8.198.0'
        },
        params: params
    };
